...
Yet Another Unzipper — a lightweight, cross-platform archive extraction tool built with [Tauri](https://tauri.app/) and Rust. Inspired by [UZip 2 from Farkway](https://www.yuque.com/farkaway/uzip/)
